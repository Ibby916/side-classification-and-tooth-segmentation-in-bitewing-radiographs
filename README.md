...
a flawless score of 1.00 across all evaluation metrics in side classification. For segmentation and numbering, SOLOv2 outperformed all other models. It showed improvements in mean Average Precision
